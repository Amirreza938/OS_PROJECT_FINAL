...
def main():
    ...
    #task: SubSystem1Task = SubSystem1Task("T4", 10, 1, 1,3, 0)
    #task0: SubSystem2Task = SubSystem2Task("T1",10,1,1,0,2)
    #task1: SubSystem2Task = SubSystem2Task("T2",10,1,1,1,2)
    #task2: SubSystem2Task = SubSystem2Task("T3",10,1,1,2,2)
    task3: SubSystem3Task = SubSystem3Task("T5",10,1,1,0,20)
    ...
    #sub_system_2 = SubSystem2(total_resources,4,4,[task0,task1,task2],resource_2_finish_flag)
    sub_system_3 = SubSystem3(total_resources,4,4,[task3],resource_3_finish_flag)
    main_system = MainSystem([sub_system_3])
    main_system.start()
    for _ in range(100):
